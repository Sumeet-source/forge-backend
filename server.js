...
// --- DATABASE (DIRECT CONNECTION - 100% BYPASSES DNS BLOCK) ---
// directConnection=true forces Mongoose to ignore SRV lookups completely
...
const connectDB = async () => {
    try {
        // Force IPv4 and give it plenty of time to connect
        const options = {
            family: 4,
