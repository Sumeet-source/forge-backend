...
// --- THE COMPLETE 16 PRODUCT LIST (With a working Sports Bra image) ---
const products = [
  ...
  { title: "Seamless Sports Bra", price: 45.00, originalPrice: 60.00, image: "https://images.unsplash.com/photo-1574680096148-d49333bf81c1?auto=format&fit=crop&w=600&q=80", category: "women", brand: "FORGE", inStock: true, rating: 4.7, colors: ['#ff69b4', '#ffffff', '#000000'], reviews: [] },
  ...
  { title: "Echo SlipSpeed™ Shoes", price: 199.00, originalPrice: 249.00, image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=600&q=80", category: "footwear", brand: "Under Armour", inStock: true, rating: 4.9, colors: ['#ff0000', '#000000'], reviews: [] }
];
...
const connectDB = async () => {
    try {
        ...
        await Product.deleteMany({}); // Wipes the broken 7 products
