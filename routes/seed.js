...
// 3. The complete 16-product list
const products = [
  ...
  { title: "Compression Base Layer", price: 50.00, originalPrice: 70.00, image: "https://images.unsplash.com/photo-1589319318227-43873c8e6873?auto=format&fit=crop&w=600&q=80", category: "men", brand: "Under Armour", inStock: true, rating: 4.8, colors: ['#000000', '#ffffff'], reviews: [] },
  ...
  { title: "Seamless Sports Bra", price: 45.00, originalPrice: 60.00, image: "https://images.unsplash.com/photo-1579564809035-6a70595711e0?auto=format&fit=crop&w=600&q=80", category: "women", brand: "FORGE", inStock: true, rating: 4.7, colors: ['#ff69b4', '#ffffff', '#000000'], reviews: [] },
  { title: "Lightweight Tank Top", price: 35.00, originalPrice: 45.00, image: "https://images.unsplash.com/photo-1581655353564-df123a1eb820?auto=format&fit=crop&w=600&q=80", category: "women", brand: "FORGE", inStock: true, rating: 4.9, colors: ['#ff69b4', '#ffffff', '#000000'], reviews: [] },
